...
const Hero = () => {
  return (
    <section
      className="relative h-[85vh] w-full bg-cover bg-center text-[#E1D8CF] flex items-center justify-start px-6 md:px-16"
      ...
      <div className="relative z-10 text-justify p-20 max-w-6xl">
        ...
        <div className="mt-8 flex flex-col text-justify md:flex-row items-center justify-start gap-8 md:gap-16">
          <div className="text-center">
            ...
            <p className="text-sm text-justify mt-1 text-[#E1D8CF]">
              4월 평균탄소 절감량
              <br />
              (kg CO2e)
            </p>
